  ...
  <div>
    <div class="signup min-h-[100vh] flex bg-[#27699c58] items-center justify-center ">
      <div class="signup-card  md:min-h-[50vh] w-[90%] lg:w-[60%] flex flex-col-reverse md:flex-row rounded-xl my-2 shadow-2xl">
        <div class="left w-full lg:w-[50%] p-8 bg-white flex flex-col justify-between ">
          <div class='text-[#2e3e6a] text-3xl py-4'>Sign Up</div>
          <form action="endpoints/signupSubmit.php" method="POST" class='flex flex-col w-full'>
            ...
            <input class="p-2 my-1 text-black border-b-2" type="text" name="username" id="username" placeholder='User Name' />
        ...
        <div class="right w-full lg:w-[50%] p-8 gap-1 md:gap-2 flex flex-col justify-between">
          ...
          <!-- <div class="text-sm md:text-md  text-white text-justify">Register yourself and connect yoursely with your friends, family and relatives.</div> -->
          <div>
