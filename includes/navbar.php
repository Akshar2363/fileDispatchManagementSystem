...
?>
  ...
  <div id="navbarSmall" class="hidden absolute top-[80px] left-0 z-50 w-full flex flex-col items-center justify-center lg:hidden gap-2 p-2">
...
?>
  ...
  <nav class="navbarBody flex flex-row items-center justify-between p-4 shadow-xl">
    ...
    <div class="flex flex-row items-cener gap-6">
      <a href="index.php" class="navbarItem">Home</a>
      <a href="about.php" class="navbarItem">About</a>
