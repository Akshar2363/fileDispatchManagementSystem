                                ...
                                <div class="uploadForm flex flex-col items-center justify-center gap-3">
                                    <form class="flex items-center justify-center w-full" id='shareFileForm'>
                                        <div class="flex w-full rounded-lg">
                                            ...
                                            <input required type="text" id="receiver" name="receiver" class="rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Username">
                                        </div>
                                        <div class="flex w-full rounded-lg">
